...
# Look into the Pattern Recognition of this lib: https://thepatternsite.com/
...
class MomentumIndicator:
    ...
    def macd(self, df: DataFrame, a: int = 12, b: int = 26, c: int = 9) -> DataFrame:
        """
    ...
    def _rma(self, df: Series, n: int = 14) -> Series:
    ...
    # TODO: Replace the DataFrame typehint with StockDataFrame once I get it made
    def rsi(self, df: DataFrame, n: int = 14) -> DataFrame:
    ...
    # TODO: Replace the DataFrame typehint with StockDataFrame once I get it made
    def atr(self, df: DataFrame, n: int = 14) -> Series:
        """
    ...
    # TODO: Replace the DataFrame typehint with StockDataFrame once I get it made
    def bollinger_bands(self, df: DataFrame, n: int = 14) -> DataFrame:
        """
            Args:
                df (DataFrame): Columns - ['open', 'high', 'low', 'close', 'adj_close', 'volume']
        """
    ...
    # TODO: Replace the DataFrame typehint with StockDataFrame once I get it made
    def adx(self, df: DataFrame, n: int = 20) -> DataFrame:
        ...
        """
        new_df = df.copy()
        new_df['avg_true_range'] = self.atr(new_df, n)
    ...
    def renko(self, df: DataFrame, n: int = 20) -> DataFrame:
